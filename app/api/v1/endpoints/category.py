...
async def create_category(db: db_depend, request: CreateCategory, admin= Depends(admin_required)):
	response = await category_crud.create_category(db, request, admin)
	return response
